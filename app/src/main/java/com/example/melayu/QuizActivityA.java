...
public class QuizActivityA extends AppCompatActivity {
    ...
    private ArrayList<QuestionA> questionList;
    private int questionCounter;
    private int questionCountTotal;
    private QuestionA currentQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            QuizDbhelperA dbhelper = new QuizDbhelperA(this);
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                        ...
                        Toast.makeText(QuizActivityA.this, "กรุณาเลือกคำตอบ", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
