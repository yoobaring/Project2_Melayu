...
public class Quiz1Activity extends AppCompatActivity {
    ...
    private ArrayList<Question1> questionList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            QuizDbHelper1 dbHelper1 = new QuizDbHelper1(this);
            questionList = dbHelper1.getAllQuestions1();
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                        ...
                        Toast.makeText(Quiz1Activity.this, "กรุณาเลือกคำตอบ", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void showNextQuestion() {
        ...
        if (questionCounter < questionCountTotal) {
            ...
            textViewQuestion.setText(currentQuestion.getQuestion_1());
            rb1.setText(currentQuestion.getOption1_1());
            rb2.setText(currentQuestion.getOption2_1());
            rb3.setText(currentQuestion.getOption3_1());
            rb4.setText(currentQuestion.getOption4_1());
    ...
    private void checkAnswer() {
        ...
        if (answerNr == currentQuestion.getAnswerNr_1()) {
            score++;
    ...
    private void showSolution() {
        ...
        switch (currentQuestion.getAnswerNr_1()) {
            case 1:
