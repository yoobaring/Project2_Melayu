...
public class QuizActivityB extends AppCompatActivity {
    ...
    private ArrayList<QuestionB> questionList;
    private int questionCounter;
    private int questionCountTotal;
    private QuestionB currentQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            QuizDbhelperB dbhelper = new QuizDbhelperB(this);
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                        ...
                        Toast.makeText(QuizActivityB.this, "กรุณาเลือกคำตอบ", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
