...
public class Quiz3Activity extends AppCompatActivity {
    ...
    private ArrayList<Question3> questionList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            QuizDbHelper3 dbHelper3 = new QuizDbHelper3(this);
            questionList = dbHelper3.getAllQuestions3();
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                        ...
                        Toast.makeText(Quiz3Activity.this, "กรุณาเลือกคำตอบ", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void showNextQuestion() {
        ...
        if (questionCounter < questionCountTotal) {
            ...
            textViewQuestion.setText(currentQuestion.getQuestion_3());
            rb1.setText(currentQuestion.getOption1_3());
            rb2.setText(currentQuestion.getOption2_3());
            rb3.setText(currentQuestion.getOption3_3());
            rb4.setText(currentQuestion.getOption4_3());
    ...
    private void checkAnswer() {
        ...
        if (answerNr == currentQuestion.getAnswerNr_3()) {
            score++;
    ...
    private void showSolution() {
        ...
        switch (currentQuestion.getAnswerNr_3()) {
            case 1:
