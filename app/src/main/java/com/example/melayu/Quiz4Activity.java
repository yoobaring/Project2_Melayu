...
public class Quiz4Activity extends AppCompatActivity {
    ...
    private ArrayList<Question4> questionList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            QuizDbHelper4 dbHelper4 = new QuizDbHelper4(this);
            questionList = dbHelper4.getAllQuestions4();
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                        ...
                        Toast.makeText(Quiz4Activity.this, "กรุณาเลือกคำตอบ", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void showNextQuestion() {
        ...
        if (questionCounter < questionCountTotal) {
            ...
            textViewQuestion.setText(currentQuestion.getQuestion_4());
            rb1.setText(currentQuestion.getOption1_4());
            rb2.setText(currentQuestion.getOption2_4());
            rb3.setText(currentQuestion.getOption3_4());
            rb4.setText(currentQuestion.getOption4_4());
    ...
    private void checkAnswer() {
        ...
        if (answerNr == currentQuestion.getAnswerNr_4()) {
            score++;
    ...
    private void showSolution() {
        ...
        switch (currentQuestion.getAnswerNr_4()) {
            case 1:
