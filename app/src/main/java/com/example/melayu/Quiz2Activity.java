...
import com.example.melayu.QuizDbHelper2;
...
public class Quiz2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            questionList = dbHelper2.getAllQuestions2();
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                        ...
                        Toast.makeText(Quiz2Activity.this, "กรุณาเลือกคำตอบ", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void showNextQuestion() {
        ...
        if (questionCounter < questionCountTotal) {
            ...
            textViewQuestion.setText(currentQuestion.getQuestion_2());
            rb1.setText(currentQuestion.getOption1_2());
            rb2.setText(currentQuestion.getOption2_2());
            rb3.setText(currentQuestion.getOption3_2());
            rb4.setText(currentQuestion.getOption4_2());
    ...
    private void checkAnswer() {
        ...
        if (answerNr == currentQuestion.getAnswerNr_2()) {
            score++;
    ...
    private void showSolution() {
        ...
        switch (currentQuestion.getAnswerNr_2()) {
            case 1:
