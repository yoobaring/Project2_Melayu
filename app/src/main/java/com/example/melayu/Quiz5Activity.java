...
public class Quiz5Activity extends AppCompatActivity {
    ...
    private ArrayList<Question5> questionList;
    private int questionCounter;
    private int questionCountTotal;
    private Question5 currentQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            QuizDbHelper5 dbHelper5 = new QuizDbHelper5(this);
            questionList = dbHelper5.getAllQuestions5();
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                        ...
                        Toast.makeText(Quiz5Activity.this, "กรุณาเลือกคำตอบ", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void showNextQuestion() {
        ...
        if (questionCounter < questionCountTotal) {
            ...
            textViewQuestion.setText(currentQuestion.getQuestion_5());
            rb1.setText(currentQuestion.getOption1_5());
            rb2.setText(currentQuestion.getOption2_5());
            rb3.setText(currentQuestion.getOption3_5());
            rb4.setText(currentQuestion.getOption4_5());
    ...
    private void checkAnswer() {
        ...
        if (answerNr == currentQuestion.getAnswerNr_5()) {
            score++;
    ...
    private void showSolution() {
        ...
        switch (currentQuestion.getAnswerNr_5()) {
            case 1:
